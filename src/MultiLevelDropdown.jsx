...
export function MultiLevelDropdown({ DataJSON, displaySubmenuString, placeholder, selectedOption }) {
    ...
    if (!canRender || !menuData) {
        return <div className="multilevel-dropdown"></div>;
    }
